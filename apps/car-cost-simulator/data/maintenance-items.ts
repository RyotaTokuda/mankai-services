...
export const MAINTENANCE_ITEMS_COMPACT: MaintenanceItem[] = [
  // ── 定期的（小額・こまめ） ──
  {
    ...
    category: "regular",
    costPerTime: 5000,
    intervalLabel: "半年ごと（年2回）",
    annualCost: 10000,
    note: "ディーラーで4〜6千円、カー用品店で3〜5千円が目安。走行5,000kmまたは半年ごと。",
  },
  {
    key: "oilFilter",
    label: "オイルフィルター",
  ...
  },
  {
    ...
    intervalLabel: "年1回",
    annualCost: 2000,
    note: "フロント2本+リア1本で1,500〜3,000円。拭きムラが出たら交換時期。",
  },
  {
    key: "washerFluid",
    label: "ウォッシャー液",
...
export const MAINTENANCE_ITEMS_KEI: MaintenanceItem[] = [
  {
    ...
    intervalLabel: "半年ごと（年2回）",
    annualCost: 7000,
    note: "軽自動車はオイル量が少なく3〜5千円。ターボ車はこまめな交換推奨。",
  },
  {
    key: "oilFilter",
    label: "オイルフィルター",
...
export const MAINTENANCE_ITEMS_LARGE: MaintenanceItem[] = [
  {
    ...
    intervalLabel: "半年ごと（年2回）",
    annualCost: 16000,
    note: "オイル量が多く6〜12千円。高性能オイル指定の車種はさらに高額。",
  },
  {
    key: "oilFilter",
    label: "オイルフィルター",
